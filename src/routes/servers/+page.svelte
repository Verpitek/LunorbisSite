...
<svelte:head>
    ...
    <meta
        name="description"
        content="Explore Lunorbis-powered Minecraft Bedrock servers"
    />
</svelte:head>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p class="page-subtitle">
                    Discover Lunorbis-powered Minecraft Bedrock servers with
                    enhanced performance and extended scripting capabilities
                </p>
            </div>
        </section>
